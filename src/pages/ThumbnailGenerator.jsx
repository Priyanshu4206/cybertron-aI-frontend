...
// New Components
import CloneModelModal from '../components/thumbnailGenerator/CloneModelModal';
import ModelCreationForm from '../components/thumbnailGenerator/ModelCreationForm';
import ProgressLoader from '../components/common/ProgressLoader';
import SuccessMessage from '../components/thumbnailGenerator/SuccessMessage';
import ThumbnailHeader from '../components/thumbnailGenerator/ThumbnailHeader';

// Data
import { historyItems, ImageGeneratorSettings } from '../utils/ImageGeneratorSettings';
import { LoadingView, EmptyState } from '../components/imageGenerator/EmptyState';
...
const ThumbnailGenerator = () => {
  ...
  // App state
  const [appState, setAppState] = useState(APP_STATES.INITIAL_MODAL);
